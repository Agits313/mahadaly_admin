if (token) {
  ...
  const url = `${base_url_api}/datamember/list`;
      ...
      /*field_area*/
      {
        ...
        render: function (data, type, row) {
          return `<div class="d-flex actionData">
            <button type="button" class="btn link-icon-green appTableButton isModal isEdit py-0" data-hasform="true" data-title="Edit Datamember" data-modal="datamember" data-id="${row.id}" data-idname="id">
                <i class="fas fa-edit"></i>
            </button>
            <button type="button" class="btn link-icon-red appTableButton isModal isDelete py-0" data-hasform="true" data-title="Delete Datamember" data-modal="datamember" data-label="${row.label}" data-id="${row.id}"  data-idname="id">
  ...
  filterContent = `<div class="col d-flex justify-content-end">
      <button type="button" class="btn btn-fill w-md-down-100 fw-semibold app_button isModal" data-hasform="true" data-height="true"
        data-modal="datamember" data-title="Input Data Datamember">
