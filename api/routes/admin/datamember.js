...
const { dev_mode, setQuery, setResponse, setDefaultNull } = require("../../helper/index");
const { setRequest } = require("./conf/datamember");
const bcrypt = require("bcrypt");
const mainurl = "/datamember";

router.post(`${mainurl}`, async (req, res) => {
  /*
  #swagger.tags = ['Datamember']
  #swagger.requestBody = {
      required: true,
      content: {
          "application/json": {
              schema: {
                  $ref: "#/components/schemas/DatamemberAdd"
              }  
          }
      }
    }
...
router.patch(`${mainurl}`, async (req, res) => {
  /*
    ...
    content: {
      "application/json": {
        schema: {
          $ref: "#/components/schemas/DatamemberUpdate"
        }
      }
    }
  }
...
router.delete(`${mainurl}`, (req, res) => {
  /*
    ...
    content: {
      "application/json": {
        schema: {
          $ref: "#/components/schemas/DatamemberDelete"
        }
      }
    }
  }
...
router.post(`${mainurl}/list`, async (req, res) => {
  /*
    ...
    content: {
      "application/json": {
        schema: {
          $ref: "#/components/schemas/DatamemberList"
        }
      }
    }
  }
