...
const { setRequest } = require("./conf/kategoribuku");

const mainurl = "/kategoribuku";

router.post(`${mainurl}`, async (req, res) => {
  /*
  #swagger.tags = ['Kategoribuku']
  #swagger.requestBody = {
      required: true,
      content: {
          "application/json": {
              schema: {
                  $ref: "#/components/schemas/KategoribukuAdd"
              }  
          }
      }
    }
...
router.patch(`${mainurl}`, (req, res) => {
  /*
    ...
    content: {
      "application/json": {
        schema: {
          $ref: "#/components/schemas/KategoribukuUpdate"
        }
      }
    }
  }
...
router.delete(`${mainurl}`, (req, res) => {
  /*
    ...
    content: {
      "application/json": {
        schema: {
          $ref: "#/components/schemas/KategoribukuDelete"
        }
      }
    }
  }
